...
public class DiagramSize
{
    ...
    public static DiagramSize Small  => new() { Preset = DiagramSizePreset.Small };
    public static DiagramSize Medium => new() { Preset = DiagramSizePreset.Medium };
    public static DiagramSize Large  => new() { Preset = DiagramSizePreset.Large };
